...
export const faqs = [
  {
    ...
    a: "Under 7 days. We configure your project structure, load your 14 phases, assign roles, and train your PMC team. Your first pilot site is typically live within a week of signing."
  },
  {
  ...
  {
    q: "Can we customize the 14-phase template for our project?",
    a: "Yes. Phases, subphases, dependency types, and approval chains are all configurable. The 14-phase template is the starting point — your workflow always takes precedence."
  },
  {
...
export const pricingTiers = [
  {
    ...
    price: "Free",
    period: "30 days",
    description: "Full platform access on a single project. No commitment, no credit card.",
    cta: "Start free pilot",
    ctaHref: "/contact",
    highlight: false,
    features: [
      "1 project · up to 3 blocks",
      "All 14 construction phases",
      "Tamper-proof photo evidence",
      "PMC approval workflow",
      "Live heatmap dashboard",
      "3 user roles included",
      "Email support"
    ]
  },
  {
    ...
    price: "₹xxxxxx",
    period: "per month",
    description: "For PMC firms running 1–10 active sites that need full enforcement and reporting.",
    cta: "Book a demo or Contact us for details",
    ctaHref: "/contact",
    highlight: true,
    features: [
      "Up to 10 projects",
      "Unlimited blocks & subphases",
      "All 14 phases + custom phases",
      "All 7 user roles",
      "AI daily reports at 9 PM",
      "Four-type snag system",
  ...
  },
  {
    ...
    name: "Enterprise",
    price: "Custom",
    period: "tailored to portfolio",
    description: "For large PMC firms and developers managing 10+ active projects across India.",
    cta: "Talk to us",
    ctaHref: "/contact",
    highlight: false,
    features: [
...
export const featureCards = [
  {
    ...
    icon: "flow",
    description:
      "Pre-configured with 14 phases for Indian residential construction \u2014 fully customizable to match your project structure. Hard gates, not suggestions."
  },
  {
